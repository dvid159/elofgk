...
CREATE TABLE `alumno` (
  ...
  UNIQUE KEY `carnet_alumno_UNIQUE` (`carnet_alumno`),
...
INSERT INTO `alumno_seccion` VALUES ('2018-SA-FT-001','A1-Class-2018','0'),('2018-SA-FT-002','A2-Class-2018','0'),('2018-SA-FT-003','A2-Class-2018','0'),('2018-SA-FT-004','A2-Class-2018','0'),('2018-SA-FT-005','A1-Class-2018','1'),('2019-SA-FT-001','A1-Class-2019','0'),('2019-SA-FT-002','A2-Class-2019','0'),('2019-SA-FT-003','A1-Class-2019','0'),('2019-SA-FT-004','A1-Class-2019','0'),('2019-SA-FT-005','A1-Class-2019','0');
...
CREATE TABLE `aptitud` (
  ...
  UNIQUE KEY `id_aptitud_UNIQUE` (`id_aptitud`),
...
INSERT INTO `aptitud` VALUES (1,1,'Puntual'),(2,1,'Tareas'),(3,1,'Asistencia'),(4,1,'vestimenta');
...
INSERT INTO `bitacora_alumno_centro_educativo` VALUES (1,'2019-SA-FT-006',20070,2019,'Noveno','Centro educativo de inicio.'),(2,'2021-SA-FT-001',20080,2021,'Noveno','Centro educativo de inicio.');
...
CREATE TABLE `centro_educativo` (
  ...
  UNIQUE KEY `codigo_centro_educativo_UNIQUE` (`codigo_centro_educativo`),
...
INSERT INTO `centro_educativo` VALUES (12547,'centro ficticio','direccion ficticia','78978945',1,NULL,'Público','Urbano','Centro Escolar'),(20058,'COLEGIO SALESIANO SAN JOSE','CALLE SALESIANO SAN JOSE, SOBRE FINAL 17 AV SUR','24860800',1,NULL,'Privado','Rural','Complejo Educativo'),(20061,'Liceo Latinoamericano','21 calle pte. entre 12 y 14 av. sur','24405055',1,NULL,'Privado','Urbano','Complejo Educativo'),(20070,'Liseo San Luis','FINAL AVENIDA FRAY FELIPE DE JESUS MORAGA SUR COLONIA SAN LUIS','24010600',1,NULL,'Privado','Urbano','Complejo Educativo'),(20080,'Colegio Santa María','AVENIDA INDEPENDENCIA SUR, 37 CALLE ORIENTE','24401490',1,NULL,'Privado','Urbano','Centro Escolar');
...
INSERT INTO `class` VALUES ('Class-2015',2013,2015,NULL),('Class-2016',2014,2016,NULL),('Class-2017',2015,2017,NULL),('Class-2018',2016,2018,NULL),('Class-2019',2017,2019,NULL),('CLASS-2020',2018,2020,NULL),('CLASS-2021',2019,2021,NULL);
...
CREATE TABLE `criterio` (
  ...
  UNIQUE KEY `id_criterio_UNIQUE` (`id_criterio`)
...
INSERT INTO `departamento` VALUES (4,'Ahuachapan'),(12,'Cabañas'),(6,'Chalatenango'),(13,'Cuscatlan'),(3,'La Libertad'),(10,'La Paz'),(8,'La Union'),(11,'Morazan'),(7,'San Miguel'),(49,'san salavador'),(2,'San Salvador'),(9,'San Vicente'),(1,'Santa Ana'),(37,'santa mirra'),(5,'Sonsonate'),(18,'Usulután');
...
CREATE TABLE `empleado` (
  ...
  UNIQUE KEY `carnet_empleado_UNIQUE` (`carnet_empleado`),
  UNIQUE KEY `email_UNIQUE` (`email`),
...
INSERT INTO `empleado` VALUES ('DA09046',3,'005101746','0210-000000-000-0','Doris','Apellido','F','2019-11-21','7777777','Direccion de Doris#',1,NULL,1,'Doris@gmailcom'),('EA11016',1,'77777778','0210-123564-123-6','Erick','Aguilar','M','2019-11-20','77777777','Direccion de Erick',1,NULL,1,'Erick@gmail.com'),('ES13013',1,'00176076-8','0210-220687-106-8','Edwin','Salazar','M','2019-11-12','77777777','ksjdfhlkjsdhflkdf',1,NULL,1,NULL),('fg12004',2,'04867795-6','0210-121093-102-1','David','Fuentes','M','2019-10-12','78799763','col. la matepec calle ppal zona a',1,NULL,1,NULL),('JP19013',1,'00510381-9','0210-231119-103-1','Juan','Perez','F','2019-11-23','7894-5612','DIreccion de Juan',1,NULL,1,'Juan@gmail.com'),('PE12012',2,'005101748-6','0210-211987-102-1','Eduardo','Peña','M','2019-11-06','77777777','direccion de Peña',1,NULL,1,NULL),('SS11013',2,'00510174-4','0210-220693-102-1','Nelson Alfredo','Salazar Salazar','M','1993-06-22','70383398','26 av sur entre 45 y 47 calle poniente',1,NULL,1,NULL);
...
INSERT INTO `municipio` VALUES (1,1,'Santa ana'),(2,1,'Chalchuapa'),(3,1,'Ahuachapan'),(6,1,'Metapan'),(7,1,'Candelaria de la Frontera'),(8,1,'El congo'),(9,2,'Santa Tecla'),(10,1,'Coatepeque'),(11,1,'El Porvenir'),(14,1,'Masahuat');
...
INSERT INTO `seccion` VALUES ('A1-Class-2017','Class-2017',2019,NULL),('A1-Class-2018','Class-2018',2019,NULL),('A1-Class-2019','Class-2019',2019,NULL),('A2-Class-2017','Class-2017',2019,NULL),('A2-Class-2018','Class-2018',2019,NULL),('A2-Class-2019','Class-2019',2019,NULL),('B1-Class-2019','Class-2019',2019,'Prueba');
...
INSERT INTO `users` VALUES (1,'Alfredo','ss11013','ss11013@gmail.com',NULL,1,0,'$2y$10$e0Jin2CvErIxAiz8.l7U5.n64MC3E/mF6Nour1cWdkjg4BwtXx/Du',NULL,'2019-11-01 02:50:50','2019-11-01 02:50:50',NULL),(2,'David','fg12004','fg12004@gmail.com',NULL,1,0,'$2y$10$Jn1eODgD8GWrV0jnWAT8r.loUf5bZF2qj68c5FH1e02G3DJ49H9Zi',NULL,'2019-11-01 02:50:50','2019-11-01 02:50:50',NULL),(5,'Eduardo','pe12012','pe12000@gmail.com',NULL,1,0,'$2y$10$9gIJufXI.DA7EVamGrHSleslOH6bKDMM32rA1.t6iZDjn76GCS9m2',NULL,'2019-11-01 02:52:14','2019-11-01 02:52:14',NULL),(6,'Docente','dc11013','docente1@gmail.com',NULL,0,1,'$2y$10$K0xr8H5kZchFUUkUeTdedu54DlVzmdSeUhuSKlQ2cEuc0QWnn.wVS',NULL,'2019-11-01 02:52:14','2019-11-01 02:52:14',NULL),(7,'User','us11013','user1@gmail.com',NULL,0,0,'$2y$10$ORYic8BvH840Wrd4ZLmAJeP.cxdRr6U34UhYHghYem98gS0w/bmna',NULL,'2019-11-01 02:52:14','2019-11-01 02:52:14',NULL),(8,'abhiman','2019-SA-FT-001','user2@gmail.com',NULL,0,0,'$2y$10$MpL4r4wNTvehbs22FKpZmusgN.1tj.JUfjhza5GZ6skpjsGfgAVCK',NULL,'2019-11-07 21:53:47','2019-11-07 21:53:47',NULL),(13,'Asistente1','AA13025','edocente2@gmail.com',NULL,1,1,'$2y$10$e/5BAhE6llSLD1sgh0RiWOx1ZueeTQ1muDJF3tuP3Nnf9A0L79/DS',NULL,'2019-11-15 03:27:13','2019-11-15 03:27:13',NULL),(15,'Edwin','ES13013','docente2@gmail.com',NULL,0,1,'$2y$10$rTLsjLukgyfvAlyi6wA42Ou5s/5RBiP4th6PuJDQlFRu/Gx/oaJSi',NULL,'2019-11-19 22:31:09','2019-11-19 22:31:09',NULL),(18,'Juan','JP19013','Juan@gmail.com',NULL,0,1,'$2y$10$jeo58o4417Vy4.ES4hkLq.yM5aT79ubopJvz20reA.xYQyMVijD.a',NULL,'2019-11-24 03:05:18','2019-11-24 03:05:18',NULL),(19,'Doris','DA09046','Doris@gmailcom',NULL,1,1,'$2y$10$d8wIzgRIgyySBiItayFmMunGKh6q3yIMuZwt0sdrTYrkYsilPkaK.',NULL,'2019-11-28 21:31:20','2019-11-28 21:31:20',NULL),(20,'Erick','EA11016','Erick@gmail.com',NULL,0,1,'$2y$10$82UipCuk/rNHlX09/hvzw.5Ug//k5I.fJKiZTOXJesLBF0Svy7aGa',NULL,'2019-11-28 23:09:18','2019-11-28 23:09:18',NULL),(21,'Alumno','2017-SA-FT-004','Inactivo@gmail.com',NULL,0,0,'$2y$10$jeFOPPAPIfqUWqyxfa6jDOKneA1TQSSSPS.bKkkZDVmQgcYyIc3.2',NULL,'2019-12-05 21:20:30','2019-12-05 21:20:30',NULL),(22,'nombre2019','2019-SA-FT-006','correo@gmail.com',NULL,0,0,'$2y$10$HDmzJ/i8jvAcNh6/OPN8M.01tMJTlOanfdCypwnnwQxRGtyPvcqai',NULL,'2019-12-12 20:55:24','2019-12-12 20:55:24',NULL),(23,'matilda','2021-SA-FT-001','matildita@gmail.com',NULL,0,0,'$2y$10$5LjoVbtwQm4F8.4svfjLmeUOtiRo1rYI8AwUI.oIws2BbyNiJOh42',NULL,'2019-12-12 21:26:44','2019-12-12 21:26:44',NULL);
...
-- Dump completed on 2019-12-13  8:33:32
