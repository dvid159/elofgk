...
class AlumnoController extends Controller
{
    ...
    {//WHERE estado = 1
        $data = DB::select('SELECT * FROM alumno WHERE estado = 1 ORDER BY id_class,estado DESC');
    ...
    public function store(Request $request){
        ...
        //$query = DB::select("SELECT anho_ingreso FROM class WHERE id_class = '$anio'");        
        $anio2 = explode('-',$anio);
        //$anio2 = $query;
